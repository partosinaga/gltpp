            ...
            <div class="page-content-inner">
                <div class="col-xs-12">
                    <div class="mt-element-ribbon bg-grey-steel">
                        ...
                        <div class="ribbon-content row">
                            <form method="GET" action="<?php echo site_url('jv/jv/short_list') ?>">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="input-icon">
                                        <div class="col-md-4">
                                            <button type="submit" class="btn green"><i class="fa fa-search"></i> Search
                                            </button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div align="right" style="font-size: 20px;font-style: italic;"><span class="label label-info">VIEWED <?php echo $month . '/' . $year ?></span>
                        </div>
                    </div>
                </div>
