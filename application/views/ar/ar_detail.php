<div class="container">
  ...
  <section class="content-header">
        <h1 class="gl">
         Approve Reciept Voucher
        </h1>
  </section>
  <section class="content">
    <div class="box box-success">
      <div class="box-header with-border">
        <h3 class="box-title"><i class="fa fa-search"></i> Receipt Voucher Detail</h3>
      </div>
      <div class="box-body">
<!-- HEADER -->
        <div class="row">
...
<!-- APPROVE/NO -->
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            <tr>
              <td>
                <form method="POST" action="<?php echo site_url().'/approve/approve/ar_suggest' ?>">
              ...
              <td>
                <div align="center">
                  ...
                  <a href="<?php echo site_url().'/approve/approve/ar_accept?id='.$trx->no_voucher.'&total='.$trx->total ?>">
