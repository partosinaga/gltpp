...
<div id="div1">
    ...
    <div id="body">
        <hr class="style3">
        <table class="table table-report table-striped table-hover"
               style="margin-top:0px;margin-bottom:15px;background:#ffffff;font-size: 12px">
            <thead>
            <tr>
            ...
            foreach ($coa as $c):
                ...
                foreach ($total_prev as $ttlp) {
                    if ($c->coa_id == $ttlp->coa_id) {
                        $d_prev = $ttlp->debit;
                        $c_prev = $ttlp->credit;
                        break;
                    } else {
            ...
            <?php $d_total = $d_total+$d_tot;$c_total=$c_total+$c_tot; endforeach ?>
