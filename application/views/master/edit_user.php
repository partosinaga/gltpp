            ...
            <?php foreach ($editUser as $eu) { ?>
                <form role="form" method="POST" action="<?php echo site_url().'/master/user/save_edit' ?>">
                  <div class="form-body">
                      ...
                      <div class="col-md-4">
                        <div class="form-group ">
                          ...
                          <div class="input-icon">
                            ...
                            <input type="email" name="email" class="form-control" value="<?php echo $eu->email ?>" ?>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                       ...
                       <div class="col-md-6">
                        ...
                        <div class="btn-group" data-toggle="buttons">
                          <label class="btn btn-primary btn-xs">
                            <input type="checkbox" name="approve" value="y" autocomplete="off">Approve
                            <span class="glyphicon glyphicon-ok"></span>
                          </label>          
                        </div>
                        <div class="btn-group" data-toggle="buttons">
                    ...
                    <button type=" " class="btn red" VALUE="Back" onClick="history.go(-1);return true;"><i class="fa fa-chevron-circle-left" ></i> Cancel</button>                     
                  </div> <hr>
