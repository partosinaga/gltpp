        ...
        <section class="content">
            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-balance-scale"></i> Balance Sheet Form v.2</h3>
                </div>
                <div class="box-body">
                    <div class="page-content-inner">
                        <form method="get" action="<?php echo site_url("balance_sheet/balance_sheetv2/view_bs") ?>" target="_blank">
                            <div class="row">
                                <div class="col-md-3">
